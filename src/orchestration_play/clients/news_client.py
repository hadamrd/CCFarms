...
from orchestration_play.utils import get_flow_aware_logger
import requests
...
if __name__ == "__main__":
    client = NewsAPIClient(api_key="3faa6bb82e26406aabacd54443696002")
    ...
    for article in articles.get('articles', []):
        ...
        if domain in NewsAPIClient.DEFAULT_SKIP_DOMAINS:
